...
class DataTransformation:
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifacts:
        logging.info("Entered initiatie_data_transformation method of DataTransformation class")
        ...
        try:
            ...
            logging.info(f"Saved transformed train array at {self.data_transformation_config.transformed_train_file_path}")

            save_numpy_array_data(self.data_transformation_config.transformed_test_file_path, array=test_arr)
            logging.info(f"Saved transformed test array at {self.data_transformation_config.transformed_test_file_path}")

            save_object(self.data_transformation_config.transformed_object_file_path, preprocessor_object)
            logging.info(f"Saved preprocessor object at {self.data_transformation_config.transformed_object_file_path}")
