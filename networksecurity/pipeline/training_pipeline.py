...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info(f"Data ingestion completed an artifact: {data_ingestion_artifact}")
    ...
    def start_model_trainer(self, data_transformation_artifact:DataTransformationArtifacts) -> ModelTrainerArtifacts:
        try:
            ...
            model_trainer = ModelTrainer(data_tranformation_artifacts=data_transformation_artifact,
